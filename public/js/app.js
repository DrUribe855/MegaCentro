  ...
  methods: {
    ...
    clinicRegister: function clinicRegister() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().post('/clinic/register', {
        ...
        _this2.clear();
        $('#register').modal('hide');
        _this2.sweetAlert('Se registro con exito el nuevo consultorio');
      })["catch"](function (error) {
        console.log("Error en servidor");
        console.log(error);
        console.log(error.response);
        _this2.sweetAlertError('Parece que estas intentando registrar un consultorio existente o algunos campos estan vacíos!');
      });
    },
    ...
    editInfo: function editInfo(clinicEdit) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().put("/clinic/update/".concat(clinicEdit.id), clinicEdit).then(function (res) {
        ...
        _this3.search = "";
        $('#edit').modal('hide');
        _this3.sweetAlert('Se modifico la informacion del consultorio con exito');
      })["catch"](function (error) {
        console.log("Error del servidor");
        console.log(error);
        console.log(error.response);
        _this3.sweetAlertError('Parece que estas intentando modificar un consultorio, es posible que algunos campos esten vacíos o intentas modificar el numero del consultorio pero este ya exite!');
      });
    },
    // Buscador
    searchProducts: function searchProducts() {
      ...
      if (this.search != '' && this.optionSearch != '') {
        axios__WEBPACK_IMPORTED_MODULE_0___default().get('/clinic/search', {
          ...
          console.log(error);
          console.log(error.response);
          _this4.sweetAlertError('Parece que algo salio mal con la busqueda!');
        });
    ...
    // Alerta de error
    sweetAlertError: function sweetAlertError(textSwetAlert) {
    ...
    // Alerta de exito
    sweetAlert: function sweetAlert(textSwetAlert) {
      sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire('OK!', textSwetAlert, 'success');
    },
...
var render = function render() {
  ...
  return _c("div", [_c("div", {
    staticClass: "row m-3 mt-2"
  }, [_c("div", {
    staticClass: "col-md-7 row mt-2"
  }, [_vm._m(0), _vm._v(" "), _vm.showButton == true ? _c("div", {
    staticClass: "col-3"
  }, [_c("button", {
    ...
    on: {
      change: function change($event) {
        ...
        _vm.optionSearch = $event.target.multiple ? $$selectedVal : $$selectedVal[0];
      }
    }
  }, [_c("option", {
    attrs: {
  ...
  }, [_vm._v("Estado")]), _vm._v(" "), _c("option", {
    attrs: {
      value: "documentNumber"
    }
  }, [_vm._v("Número de Documento")]), _vm._v(" "), _c("option", {
    attrs: {
      value: "clinicNumber"
    }
  }, [_vm._v("Número de Consultorio")])]), _vm._v(" "), _c("div", {
    staticClass: "form-text",
    attrs: {
      id: "emailHelp"
    }
  }, [_vm._v("Debe elegir la opción de búsqueda.")])]), _vm._v(" "), _c("div", {
    staticClass: "col-md-6"
  }, [_c("input", {
    directives: [{
      name: "model",
  ...
  })])])])]), _vm._v(" "), _vm.spinner == false ? _c("div", {
    staticStyle: {
      "padding-top": "100.000%",
      position: "relative",
      "margin-left": "30%"
  ...
  }, [_vm._v("Ingrese el numero de documento del responsable del consultorio.")])]), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v("Estado del consultorio")]), _vm._v(" "), _c("select", {
    directives: [{
      name: "model",
      rawName: "v-model",
    ...
    on: {
      change: function change($event) {
        ...
        _vm.$set(_vm.clinicEdit, "status", $event.target.multiple ? $$selectedVal : $$selectedVal[0]);
      }
    }
  }, [_c("option", {
    attrs: {
  ...
  }, [_vm._v(_vm._s(_vm.clinicEdit.status))]), _vm._v(" "), _c("option", {
    domProps: {
      value: _vm.clinicEdit.status == "ACTIVO" ? "INACTIVO" : "ACTIVO"
    }
  }, [_vm._v(_vm._s(_vm.clinicEdit.status == "ACTIVO" ? "INACTIVO" : "ACTIVO"))])])]), _vm._v(" "), _c("div", {
    staticClass: "modal-footer"
  }, [_c("button", {
    staticClass: "btn btn-secondary",
    attrs: {
