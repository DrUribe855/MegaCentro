    ...
    <div class="bg-white" style="height: 100vh; overflow-y: scroll"> 
        <v-app>
            <v-main>
                <template>
                    <div class="my-6">
                        <h1 class="text-center">Tarifas de los residuos (KG)</h1>
                        <v-card-text>
                            <div>RESIDUO NO PELIGROSO</div>
                            <div class="row text--primary mt-6">
                                <div class="col-m-2 col-sm-3 text-center">
                                    <h6>Biodegradable</h6>
                                    <v-text-field
                                        v-model="biodegradable"
                                        type="text"
                                        value=""
                                        prefix="$"
                                        @click="biodegradableClick"
                                ...
                                <div class="col-m-2 col-sm-3 text-center">
                                    <h6>Oridinarios-Comunes</h6>
                                    <v-text-field
                                        v-model="oridinarios"
                                        type="text"
                                        value=""
                                        prefix="$"
                                        @click="oridinariosClick"
                        ...
                        <v-card-text>
                            <div>RESIDUO PELIGROSO</div>
                            <p class="text-h4 text--primary text-center">
                                Infeccioso o riesgo biologico
                            </p>
                            <div class="row text--primary mt-6">
                                <div class="col-m-2 col-sm-3 text-center">
                                    <h6>Biosanitarios</h6>
                                    <v-text-field
                                        v-model="biosanitarios"
                                        type="text"
                                        value=""
                                        prefix="$"
                                        @click="biosanitariosClick"
                                        @input="biosanitariosFormater"
                                    ></v-text-field>
                                </div>
                                <div class="col-m-2 col-sm-3 text-center">
                                    <h6>Anatomopatologicos</h6>
                                    <v-text-field
                                        v-model="anatomopatologicos"
                                        type="text"
                                        value=""
                                        prefix="$"
                                        @click="anatomopatologicosClick"
                                        @input="anatomopatologicosFormater"
                                    ></v-text-field>
                                </div>
                                <div class="col-m-2 col-sm-3 text-center">
                                    <h6>Cortopunzantes</h6>
                                    <v-text-field
                                        v-model="cortopunzantes"
                                        type="text"
                                        value=""
                                        prefix="$"
                                        @click="cortopunzantesClick"
                            ...
                            <div class="row text--primary mt-6">
                                ...
                                <div class="col-m-3 col-sm-4 text-center">
                                    ...
                                    <v-text-field
                                        ...
                                        value=""
                                        prefix="$"
                                        @click="citotoxicosClick"
                                        @input="citotoxicosFormater"
                                    ></v-text-field>
                                </div>
                                <div class="col-m-3 col-sm-4 text-center">
                                    <h6>Metales pesados</h6>
                                    <v-text-field
                                        v-model="metales"
                                        type="text"
                                        value=""
                                ...
                                <div class="col-m-3 col-sm-4 text-center">
                                    ...
                                    <v-text-field
                                        ...
                                        value=""
                                        prefix="$"
                                        @click="reactivosClick"
                                        @input="reactivosFormater"
                                    ></v-text-field>
                                </div>
                                <div class="col-m-3 col-sm-4 text-center">
                                    <h6>Contenedores presurizados</h6>
                                    <v-text-field
                                        v-model="contenedores"
                                        type="text"
                                        value=""
                                        prefix="$"
                                        @click="contenedoresClick"
                                        @input="contenedoresFormater"
                                    ></v-text-field>
                                </div>
                                <div class="col-m-3 col-sm-4 text-center">
                                    <h6>Aceites usados</h6>
                                    <v-text-field
                                        v-model="aceites"
                                        type="text"
                                        value=""
    ...
    export default {
        ...
        methods: {
            ...
            dataArray(){
                ...
                this.data[2] = this.inertes;                    
                this.data[3] = this.oridinarios;                    
                this.data[4] = this.biosanitarios;                    
                this.data[5] = this.anatomopatologicos;                    
                this.data[6] = this.cortopunzantes;                    
                this.data[7] = this.aniamales;                    
                this.data[8] = this.farmacos;                    
                this.data[9] = this.citotoxicos;                    
                this.data[10] = this.metales;                    
                this.data[11] = this.reactivos;                    
            ...
            citotoxicosFormater(){
                this.citotoxicos = accounting.formatMoney(this.citotoxicos, {
                    symbol: '',
                    precision: '',
                    thousand: ',',
                    decimal: '.'
            ...
            biosanitariosClick(){
                this.biosanitarios = 0;
            },

            anatomopatologicosClick(){
                this.anatomopatologicos = 0;
            },

            cortopunzantesClick(){
                this.cortopunzantes = 0;
            },
